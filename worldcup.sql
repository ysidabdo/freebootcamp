...
ALTER TABLE IF EXISTS ONLY public.games DROP CONSTRAINT IF EXISTS fk_winner;
ALTER TABLE IF EXISTS ONLY public.games DROP CONSTRAINT IF EXISTS fk_opponent;
...
--
-- Name: games fk_opponent; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: games fk_winner; Type: FK CONSTRAINT; Schema: public; Owner: -
--
